...
<div class="container">
    ...
    <!-- Start of sachet uddami -->
    <div class="menu animated wow fadeIn">
        <h4 class="animated wow flipInY"><span >सचेत उद्यमी</span></h4>
    </div>
    <br>
    ...
    <div class="row text-center">
        ...
        <div class="col-sm-4 container">  
            <div class=" card shadow video-card">
                <a href="">
            <img class="animated wow flipInX delay02" src="https://img.youtube.com/vi/pF9HmEOTMQY/mqdefault.jpg" width="100%">
            <h4 class = "animated wow fadeIn"><b>कम्पनी दर्ता कम्पनी दर्ताकम्पनी दर्ताकम्पनी दर्ताकम्पनी दर्ताकम्पनी दर्ताकम्पनी दर्ताकम्पनीकम्पनी</b></h4>
            <br>
            </a>
            </div>   
        </div>
        ...
        <div class="col-sm-4 container">
            <div class=" card shadow video-card">
                <a href="">
            <img class="animated wow flipInX delay02" src="https://img.youtube.com/vi/pF9HmEOTMQY/mqdefault.jpg" width="100%">
            <h4 class = "animated wow fadeIn"><b>कम्पनी दर्ता</b></h4>
            <br>
        </a>
            </div>
        </div>
        ...
        <div class="text-center">
            <div class="view-more"><a href=""><i class="fa fa-arrow-right"></i> View More</a>
            </div> 
            </div> 
    <!-- End of sachet uddami -->
    ...
    <!-- Start of suruwat uddham ko -->
    <br><br>
    <div class="menu animated wow fadeIn">
        <h4 class="animated wow flipInY"><span >सुरूवात उद्यमकाे</span></h4>
    </div>
    <br>
    ...
    <!-- Start of uddami katha -->
    <br><br>
    <div class="menu animated wow fadeIn">
        <h4 class="animated wow flipInY"><span >उद्यमी कथा</span></h4>
    </div>
    <br>
